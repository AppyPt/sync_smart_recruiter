...
class SmartRecruiterBot:
    ...
    def _process_individual_cell(self, individual_cell_image_pil, circle_info_in_list_image, cell_start_x_in_list, cell_start_y_in_list, name_sub_region_calib, profile_sub_region_calib):
